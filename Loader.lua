...
-- ui -- 
local ui = game:GetService("CoreGui"):FindFirstChild("Island Hub| Blox Fruit (Released)")
if ui then
   ui:Destroy()
end
-- init
...
games:addButton("Copy Discord Server(Join or gay)",function()
   setclipboard("https://discord.gg/GNwkWkcbQN")
end)
   ...
   while game:GetService("RunService").RenderStepped:wait() do
     if  getgenv().Queue then
      ...
      queue_on_teleport([[
        ...
        loadstring(game:HttpGet(('https://raw.githubusercontent.com/VibreBeast/Simulator/main/Loader.lua'),true))()
...
spawn(function()
   ...
   while wait() do
      ...
      elseif getgenv().AutoBlackBeardHop then
         if SecondWorld then
            ...
            lib:Notify("Auto Black Beard Hop","You must go to Second Sea")
   ...
   elseif getgenv().AutoLibraryKeyHop then
      if SecondWorld then
         ...
         lib:Notify("Auto Library Key Hop","You must go to Second Sea")
   ...
   elseif getgenv().AutoWaterKeyHop then
      if SecondWorld then
         ...
         lib:Notify("Auto Water Key Hop","You must go to Second Sea")
...
lib:Notify("Island Hub","Loaded")
wait(0.1)
lib:Notify("Island Hub","Ui Made by Vibre")